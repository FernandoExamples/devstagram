    ...
    <div class="md:flex md:items-center">
        ...
        <div class="mt-10 rounded-lg bg-white p-10 shadow-xl md:mt-0 md:w-1/2">
            <form action="{{ route('posts.store') }}" method="POST">
                ...
                <div>
                    <div class="mb-5">
                        <label for="title" class="mb-2 block font-bold uppercase text-gray-500">Título</label>
                    ...
                    <div class="mb-5">
                        <label for="description" class="mb-2 block font-bold uppercase text-gray-500">Descripción</label>
                ...
                <div class="mb-5">
                    <input type="hidden" id="image_path" name="image_path" value="{{ old('image_path') }}">
