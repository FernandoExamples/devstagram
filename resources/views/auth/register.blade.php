            ...
            <form
                ...
                <div>
                    <div class="mb-5">
                        <label
                               for="name"
                               class="mb-2 block font-bold uppercase text-gray-500">Nombre</label>
                        <input
                               type="text"
                               id="name"
                               name="name"
                    ...
                    <div class="mb-5">
                        <label
                               for="username"
                               class="mb-2 block font-bold uppercase text-gray-500">Nombre de Usuario</label>
                        <input
                               type="text"
                               id="username"
                               name="username"
                    ...
                    <div class="mb-5">
                        <label
                               for="password"
                               class="mb-2 block font-bold uppercase text-gray-500">Contraseña</label>
                        <input
                               type="password"
                               id="password"
                               name="password"
                    ...
                    <div class="mb-5">
                        <label
                               ...
                               class="mb-2 block font-bold uppercase text-gray-500">Repite tu contraseña</label>
                        <input
                               type="password"
